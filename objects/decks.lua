SMODS.Back{
    ...
    key = "j_test",
    pos = { x = 0, y = 0 },
    config = { jokers = { "j_rj_one", "j_rj_two", "j_rj_three", "j_rj_four", "j_rj_six", "j_rj_eight", "j_rj_nine", "j_rj_x" }, consumables = { "c_aura", "c_aura", "c_strength", "c_chariot", "c_sigil", "c_hanged_man", "c_rj_insomnia" } },
