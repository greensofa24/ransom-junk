...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    //vec2 rotater = vec2(cos(cool.r*0.1221), sin(cool.r*0.3512));


    if (cool.g > 0.0 || cool.g < 0.0) {
        hsl.y = 0.02;
        hsl.z *= (1 - adjusted_uv.x*(cos(cool.r*0.512)));
        hsl.z *= (1 - adjusted_uv.y*(cos(cool.r*0.512)));
    }
